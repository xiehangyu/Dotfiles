...
$\bm{k}\cdot{\bm{\mu}}$.} To this end, we begin by constructing the mean-field Lindbladian action. The Hamiltonian of the weakly interacting bosonic system reads as
\begin{eqnarray}
