...
double calculate_N_th_order(int N,MatrixXcd covariance_matrix)
{
    static mypower mp3(6);
    static mypower mp4(8);
    static mypower mp5(10);
    mypower mp;
    switch(N)
    {
        case 3:
    ...
    auto eigenvalues_array=eigenval.eigenvalues();
    return eigenval.eigenvalues().unaryExpr([](double x){return mp(x);}).sum();
