...
def FigureC():
    ...
    fp3=open('.fit/Falling_400nm_vacuum_Origin.txt','r')
    fp4=open(".fit/Falling_400nm_vacuum_Fitting.txt",'r')
    fp5=open('.fit/Falling_400nm_air_Origin.txt','r')
    fp6=open('.fit/Falling_400nm_air_Fitting.txt','r')
