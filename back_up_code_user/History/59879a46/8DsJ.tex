\documentclass[twocolumn,english,prr,aps,superscriptaddress,longbibliography,amsmath,amssymb,floatfix]{revtex4-1}
...
While finalizing this manuscript, a related
work by Isoue \emph{et al}. appeared in Ref.~\cite{Iosue2022}, which reported the %Page curve and 
typicality for random bosonic Gaussian states. Their results are conceptually similar with our Eq. (\ref{eq:main_text_typicality_for_entropy}) but on different systems and proved by different methods.
...
\begin{figure}
\begin{center}
\includegraphics[width=1.0\columnwidth]{figs/period2range3Taylor_complete}
