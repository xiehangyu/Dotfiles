...
\begin{frame}
   ...
   \begin{equation*}
   \mathbb{P}\left(\left\{ \ket{\phi}|T(\rho_{\phi},\Omega_{A})\geq\epsilon+\frac{1}{2}\sqrt{\frac{\mathrm{dim}_{A}}{\mathrm{dim}_{E}^{\mathrm{eff}}}}\right\} \right)\leq4\exp{\left(-\frac{2}{9\pi^{3}}d_{S}\epsilon^{2}\right)}
   \end{equation*}
