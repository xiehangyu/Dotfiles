...
In this section, we \pk{investigate} the quantum depletion \pk{part} of the molecular BEC. \pk{Furthermore, we calculate the superfluid density in the quantum depletion part by considering a coordinate transformation $\bm{v}\to\bm{v}-\bm{\mu}$ and the normal density by considering a coupling field to the action 
...
\end{equation}
where $n_{\alpha}:=\sum_{\bm{k}}a^{\dagger}_{\bm{k}\alpha}a_{\bm{k}\alpha}$. We define the phase stiffness as \citep{Coleman_2015}
\begin{equation}
