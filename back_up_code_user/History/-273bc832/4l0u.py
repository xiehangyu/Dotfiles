...
def test_a_class_of_Dual_MT():
    ...
    Z=np.array([[1,0],[0,-1]])
    I=np.eye(2)   
    Oas.append(kron_product([Op_h@Z@Op_hI,Op_v@Z@Op_vI,Op_h@Z@Op_hI,I,I,I,Op_v@Z@Op_vI,I,I,I,I,I]))
    Oas.append(kron_product([I,I,Op_h@Z@Op_hI,Op_v@Z@Op_vI,Op_h@Z@Op_hI,I,I,I,I,Op_v@Z@Op_vI,I,I]))
    Oas.append(kron_product([I,I,I,I,I,Op_h@Z@Op_hI,Op_v@Z@Op_vI,Op_h@Z@Op_hI,Op_v@Z@Op_vI,I,I,I]))
    Oas.append(kron_product([I,I,I,I,I,I,I,Op_h@Z@Op_hI,I,Op_v@Z@Op_vI,Op_h@Z@Op_hI,Op_v@Z@Op_vI]))
