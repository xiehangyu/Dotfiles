...
\begin{align*}
    ...
    & =1.764\times10^{-12}F.
\end{align*}
The capacitance of the junction is much larger (about) than that of the plate capacitor, which means that the junction is more sensitive to the external electric field.
