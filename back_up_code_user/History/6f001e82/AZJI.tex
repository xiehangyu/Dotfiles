...
In this section, we \pk{investigate} the quantum depletion \pk{part} of the molecular BEC. \pk{We calculate the superfluid density in the quantum depletion part by considering a coordinate transformation $\bm{v}\to\bm{v}-\bm{\mu}$ and the normal density by considering a coupling field to the action 
