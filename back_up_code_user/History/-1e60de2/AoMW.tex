...
with the Lee-Yang circle theorem for the Ising spin system. This indicates that the geometry of Yang-Lee zeros is directly connected to the Fermi-surface instability. Furthermore, we unveil the nonunitary criticality in BCS superconductivity that emerges at each individual Yang-Lee zero as an exceptional point and presents a universality class distinct from that of the conventional Yang-Lee edge singularity. %Our results show a universal structure of Yang-Lee zeros in systems subject to Fermi-surface instabilities.
\end{abstract}
\maketitle
\emph{Introduction}.---
...
an imaginary magnetic field to understand the mathematical origin of non-analyticity of the ferromagnetic phase transition. %They showed Lee-Yang circle theorem \cite{PhysRev.87.404,PhysRev.87.410} that zeros
