...
def random_dual_PEPS(D,chi):
    while True:
        ...
        vectorizedchannel=vectorizedchannel(PEPS,D,chi)
        fold_c=project_to_dual(vectorizedchannel,chi)
        matrix_c=fold_c.reshape([chi**2]*4).transpose([0,2,4,6,1,3,5,7]).reshape([chi**4]*2)
