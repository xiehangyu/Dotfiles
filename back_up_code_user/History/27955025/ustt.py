...
def MPS_contraction_general_with_fixed_point_from_op(O1,O2,x1,x2,y1,y2,C_array,D,chi):
    #Here we assume y2>y1
    fold_o1=folded_operator_tensor(C_array,O1,D,chi)
    fold_o2=folded_operator_tensor(C_array,O2,D,chi)
    fold_c=foldedchannel(C_array,D,chi)
    return MPS_contraction_general_with_fixed_point(fold_o1,fold_o2,x1,y1,x2,y2,fold_c,chi)
