...
We here relate the number of roots of Yang-Lee zeros $\chi$ with the non-analyticity of the condensation energy. According to the definition of the order of the Yang-Lee zeros in the main text, we have
\begin{equation}
...
\end{equation}
Hence, we have $\Delta E=-\frac{\pi^2N\rho_0}{2\beta^2}\chi^2\propto(\chi/\beta)^2$ near the origin. This tells us the information of condensation energy on the real axis can be read from the number of roots on the complex plane.
