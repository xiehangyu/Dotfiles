...
def compared_with_PRRxx():
    ...
    for h in [0.2,0.4,0.5,0.8]:
        ...
        for N in [50,100,200,400,800]:
            ...
            plt.plot(ts,np.exp(Entropys),label='N={}'.format(N))
        if h==0.3 or h==0.7:
        ...
        plt.savefig("/home/xiehangyu/yxh/study/mpq/Long_range_area_law/script/figs/XXexpexactcompared_a_alpha{}h{}.png".format(alpha,h))
        plt.show()
    t=0.02
    tend=120
    GSE=25
    for h in [0.2,0.5]:
        ...
        plt.legend()
        plt.title(r"$\alpha={},h={}$".format(alpha,h))
        plt.savefig("/home/xiehangyu/yxh/study/mpq/Long_range_area_law/script/figs/XXexpcompared_a_alpha{}h{}.png".format(alpha,h))
        plt.show()
    for h in [0.2,0.5]:
        if h==0.5:
            t=0.02
        ...
        plt.savefig("/home/xiehangyu/yxh/study/mpq/Long_range_area_law/script/figs/XXexpcompared_a_alpha{}h{}.png".format(alpha,h*2))
        plt.show()
    for h in [0.2,0.5]:
        if h==0.5:
            t=0.02
    ...
    for h in [0.0,0.2,0.5,2.0]:
        ...
        plt.legend()
        plt.title(r"$\alpha={},h={}$".format(alpha,h*2))
        plt.savefig("/home/xiehangyu/yxh/study/mpq/Long_range_area_law/script/figs/XXexpcompared_c_alpha{}h{}.png".format(alpha,h*2))
        plt.show()
    alpha=0.7
    GSE=22
    for h in [0.0,0.2,0.5,2.0]:
        ...
        plt.legend()
        plt.title(r"$\alpha={},h={}$".format(alpha,h*2))
        plt.savefig("/home/xiehangyu/yxh/study/mpq/Long_range_area_law/script/figs/XXexpcompared_d_alpha{}h{}.png".format(alpha,h*2))
        plt.show()
...
def uniform_in_one_picture2():
    ...
    plt.rcParams.update({'font.size': 30})
    plt.figure(figsize=(12,8))
   #for alpha in [0.0,0.1,0.4,0.8,-100]:
    ...
    plt.savefig("/home/xiehangyu/yxh/study/mpq/Long_range_area_law/script/figs/Semilogh{}N{}.png".format(h*2,N))
    plt.show()
    h=0.2
    plt.figure(figsize=(12,8))
