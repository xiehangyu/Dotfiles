...
as 
\begin{equation}
S=\int_{-\infty}^{\infty}dt\left[\pk{\frac{V}{(2\pi)^3}d^3}\bm{k}(a_{\bm{k}+}^{\dagger}i\partial_{t}a_{\bm{k}+}-a_{\bm{k}-}^{\dagger}i\partial_{t}a_{\bm{k}-})-H_{+}+H_{-}-4i\gamma n\sum_{\bm{k}}a_{\bm{k}-}^{\dagger}a_{\bm{k}+}\right],
\end{equation}
where
\begin{align}
