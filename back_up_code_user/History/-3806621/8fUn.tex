...
\begin{figure}[h]
\centering
\includegraphics[width=0.5\textwidth]{./fig/curve.png}
...
thus from the plot $I_{c}=4.715mA$. For $I_{R}$ which is determined as a turning point of the curve, can be obtained approximately from the current-voltage-curve as $I_R=0.282888mA$.
