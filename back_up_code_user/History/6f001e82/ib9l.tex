...
\end{equation}
\begin{eqnarray}
-H_{+}+H_{-}-4i\gamma n\pk{\frac{V}{(2\pi)^3}d^3}\bm{k}a_{\bm{k}-}^{\dagger}a_{\bm{k}+} & = & \sum_{\bm{k}}-(\varepsilon_{\bm{k}}+U_{R}n-2i\gamma n)a_{\bm{k},A}^{\dagger}a_{\bm{k},R}-(\varepsilon_{\bm{k}}+U_{R}n+2i\gamma n)a_{\bm{k},R}^{\dagger}a_{\bm{k},A}\nonumber \\
