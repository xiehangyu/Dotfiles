...
def HT_Plot(x,y,colormap='hsv',figname="HT_AVLog1.pdf",T=None):
    ...
    '''
    ??log??????????????minor ticks,????????1E-1,1E0,1E1???????§Þ?????????????2??4??20??40??????????????§à?????log???????????????????????????????????????
    '''
    plt.minorticks_on()
    '''
    ????minorticks???????subticks??????????????????§»??????§³????
    ...
    '''
    ??yscale??symlog?§µ?????????????????????????????????????-linthresh,linthresh???????????????????linscale???????????????????(0,linthresh)????????????????????????????????????????????????????????????????‚k???????????python??default???????????????????????????????‚k???????????????????????????
    '''
    plt.yscale('symlog',linthresh=0.1,linscale=1.0,subs=subticks)
    '''
    ????????ï…?????????????fontsize????????????30??????????????40????PPT????????????????????????????§á????????
    '''
