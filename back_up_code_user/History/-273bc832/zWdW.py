...
def test_a_class_of_Dual_MT():
    ...
    Oas.append(kron_product([I,I,Op_h@X@Op_hI,I,I,I,Op_v@X@Op_vI,Op_h@X@Op_hI,I,Op_v@X@Op_vI,I,I]))
    finding_op=np.eye(2**12)-0.25*Oas[0]-0.25*Oas[1]-0.25*Oas[2]-0.25*Oas[3]-0*Oas[4]
