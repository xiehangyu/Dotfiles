...
Here the $f$-sum rule is a direct consequence of the weak U(1) symmetry of the Lindbladian \eqref{eq: Lindblad} even with the breaking of the strong U(1) symmetry, which leads to the decay of particle number~\cite{Albert2014,Sieberer_2016}. This is because the weak U(1) symmetry here still preserves the \pk{sout{vanishing of the coherent parts of the density matrix.} block diagonal form of the density matrix in the particle number basis.} Those \pk{\sout{coherent parts}non-diagonal parts} lead to the violation of the $f$-sum rule \pk{since they involve the non-vanishing expectation values of the form $a_\bm{r}^2$}. We note that this $f$-sum rule \eqref{eq:Application_sum_rule} is a general result without using any approximation.  
