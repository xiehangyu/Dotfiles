...
def Moses_Move_withoutbound(C_arrays,chi,D):
    ...
    bottom_lay_C_arrays=[]
    Upper_lay_C_arrays=[]
    tensorA,tensorB,tensorC=addtrianglewithoutbound(C_arrays[0].transpose([0,1,2,4,3]).reshape(D*chi**2,chi,chi),chi)
    ...
    for i in range(1,Lx-1):
        tensorA,tensorB,tensorC=addtrianglewithoutbound(newtensor,chi)
    ...
    bottom_lay_C_arrays.append((u).reshape([D,newtensor.shape[0]//D//chi,chi,chi,s.shape[0]]))
