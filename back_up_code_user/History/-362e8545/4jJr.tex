...
\[
\langle\mathrm{Tr}(\Pi_{A}UC_{0}U^{\dagger}\Pi_{A}^{\dagger})^{2}\rangle=\int d_{H}(U)\mathrm{Tr}[(\Pi_{A}\otimes\Pi_{A})(UC_{0}U^{\dagger}\otimes \Pi_{A}UC_{0}U^{\dagger})\mathrm{SWAP}_{RR'}(\Pi_{A}^{\dagger}\otimes\Pi_{A}^{\dagger})],
\]
