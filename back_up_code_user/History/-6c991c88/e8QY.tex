...
By a slightly different choice, we can demand $\bar{\beta}=\beta^\dagger$ since the original action is Hermitian. In this case, the Bogoliubov transformation is given by Eq. ()
