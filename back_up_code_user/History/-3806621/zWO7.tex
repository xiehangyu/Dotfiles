...
As shown in figure(\textcolor{red}{?}), we plot the current-voltage-curve in the certain region to have a clear view of the switching of voltage,
...
To determine $R_{n}$, we used Mathematica to get a fit of the current-voltage-curve. The fit is shown in figure(\textcolor{red}{?}).
