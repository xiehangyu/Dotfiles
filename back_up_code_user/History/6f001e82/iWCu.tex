...
\begin{equation}
-\langle J_{a}\rangle=\frac{1}{V}\frac{\partial F}{\partial v_{a}}=-\frac{m}{\beta V}\pk{\frac{V}{(2\pi)^3}\int d^3\bm{k}\sum_n}\text{Tr}[\sigma_{z}\nabla_{a}\varepsilon_{\bm{k}-m\bm{v}\sigma_{z}}\mathcal{G}(\bm{k},i\omega_n)].
\end{equation}
In this case the phase stiffness is given by 
\begin{eqnarray}
Q'_{ab} & = & -\frac{1}{V}\frac{\partial^{2}F}{\partial v_{a}\partial v_{b}}|_{v=0}\nonumber \\
 & = & -\frac{m^{2}}{\beta V}\pk{\frac{V}{(2\pi)^3}\int d^3\bm{k}\sum_n}\text{Tr}[\nabla_{ab}^{2}\varepsilon_{\bm{k}}\mathcal{G}]+\frac{m^{2}}{\beta V}\pk{\frac{V}{(2\pi)^3}\int d^3\bm{k}\sum_n}\nabla_{a}\varepsilon_{k}\nabla_{b}\varepsilon_{k}\text{Tr}[\sigma_{z}\mathcal{G}\sigma_{z}\mathcal{G}]\\
 & = & -\frac{m^{2}}{\beta V}\pk{\frac{V}{(2\pi)^3}\int d^3\bm{k}\sum_n}\nabla_{a}\varepsilon_{k}\nabla_{b}\varepsilon_{k}\text{Tr}[\sigma_{z}\mathcal{G}\sigma_{z}\mathcal{G}-\mathcal{G}^{2}]\nonumber \\
 & = & -\frac{m^{2}}{2\beta V}\pk{\frac{V}{(2\pi)^3}\int d^3\bm{k}\sum_n}\nabla_{a}\varepsilon_{k}\nabla_{b}\varepsilon_{k}\text{Tr}[\sigma_{z},\mathcal{G}]^{2}.
\end{eqnarray}
...
$(\gamma n)^{3/2}$, which indicates that the quantum depletion\pk{, at least at the same order,} is
...
\begin{equation}
  Q_{a b} = i \frac{4 m^2}{V} \pk{\frac{V}{(2\pi)^3}\int d^3\bm{k}\sum_n} \frac{k_a k_b}{m^2} \frac{- | b |^2}{2 |
...
\end{equation}
with different $a_1, a_2$ defined above. We note that here the phase stiffness takes different value depends on the direction due to the anisotropic dipolar interaction. To proceed further, we \pk{average} the direction of the the applied perturbation. From Eq. \eqref{eq:newphase}, we find that
...
\begin{equation}\label{eq: anisotropic_1}
  Q_{a a} = i \frac{4 m^2}{V} \pk{\frac{V}{(2\pi)^3}\int d^3\bm{k}\sum_n} \frac{q (k) k^2}{m^2} (\cos \theta \cos
...
\end{equation}
\begin{eqnarray}
-H_{+}+H_{-}-4i\gamma n\pk{\frac{V}{(2\pi)^3}d^3}\bm{k}a_{\bm{k}-}^{\dagger}a_{\bm{k}+} & = & \pk{\frac{V}{(2\pi)^3}d^3}\bm{k}-(\varepsilon_{\bm{k}}+U_{R}n-2i\gamma n)a_{\bm{k},A}^{\dagger}a_{\bm{k},R}-(\varepsilon_{\bm{k}}+U_{R}n+2i\gamma n)a_{\bm{k},R}^{\dagger}a_{\bm{k},A}\nonumber \\
...
\begin{equation}
S=\frac{1}{2}\pk{\frac{V}{(2\pi)^3}d^3}\bm{k}\int\frac{d\omega}{2\pi}\left(\begin{array}{cccc}
...
\approx & \frac{1}{2}N^{2}V_{dd}(0)+\frac{N}{2}\pk{\frac{V}{(2\pi)^3}d^3}\bm{k}a_{\bm{k}}a_{-\bm{k}}V_{dd}(\bm{k})+\frac{N}{2}\pk{\frac{V}{(2\pi)^3}d^3}\bm{k}a_{\bm{k}}^{\dagger}a_{-\bm{k}}^{\dagger}V_{dd}(\bm{k})\\
+ & \pk{\frac{V}{(2\pi)^3}d^3}\bm{k}a_{\bm{k}}^{\dagger}a_{\bm{k}}[V_{dd}(0)+V_{dd}(\bm{k})]N.
\end{aligned}
\end{equation}
Thus, the effective interaction in the Keldysh contour can be written
as 
\begin{equation}
S=\int_{-\infty}^{\infty}dt\left[\pk{\frac{V}{(2\pi)^3}d^3}\bm{k}(a_{\bm{k}+}^{\dagger}i\partial_{t}a_{\bm{k}+}-a_{\bm{k}-}^{\dagger}i\partial_{t}a_{\bm{k}-})-H_{+}+H_{-}-4i\gamma n\pk{\frac{V}{(2\pi)^3}d^3}\bm{k}a_{\bm{k}-}^{\dagger}a_{\bm{k}+}\right],
\end{equation}
where
\begin{align}
H_{\alpha}=&\frac{[U_{R}+V_{dd}(0)]n}{2}N+\pk{\frac{V}{(2\pi)^3}d^3}\bm{k}\Bigg[(\varepsilon_{\bm{k}}+(U_{R}+V_{dd}(\bm{k})n-2i\alpha\gamma n)a_{\bm{k}\alpha}^{\dagger}a_{\bm{k}\alpha}\nonumber\\
