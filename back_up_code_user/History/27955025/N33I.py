...
def MPS_contraction_general_with_fixed_point(fold_o1,fold_o2,x1,y1,x2,y2,fold_c,chi):
    #Here we assume y2>y1
    if y1==0:
        return MPS_direct_contraction(fold_o1,fold_o2,x2-x1,y2-y1,fold_c,chi)
    if y1>0:
        return MPS_fixedpoint_contraction(fold_o1,fold_o2,x2-x1,y2-y1,fold_c,chi)
