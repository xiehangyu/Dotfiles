...
def reduced_calculate_correlators(W,positions,op1=None,op2=None):
    ...
    print("The error is {}".format(np.abs(expect1-expectation_value(foldedchannel(C_array),fold_O1,0,2))))
    print("The expectation value 1 is {}".format(expect1))
    correlators=[]
    for x,y in positions:
        print("({},{})".format(x,y))
        expect2=reduced_W_expect(W,fold_O2,y)
        print("The error is {}".format(np.abs(expect2-expectation_value(foldedchannel(C_array),fold_O2,y,2))))
