...
/ \gamma n$.
\includegraphics*[width=0.5\linewidth]{./figs/spectrum.pdf}
...
\includegraphics*[width=1.0\linewidth]{./figs/toolong.png}
...
\begin{equation}
  ...
  \end{array}\right) \left(\begin{array}{cc}
    O_{2 \times 2} & i\partial t \sigma_z+H'\\
    i\partial t \sigma_z+\bar{H'} & O_{2 \times 2}
  \end{array}\right) \left(\begin{array}{c}
    \beta_{\tmmathbf{k}, R}\\
...
\begin{equation}
  H' = \left(\begin{array}{cc}
    - \left( - 2 i \gamma - \sqrt{\varepsilon_{\tmmathbf{k}}
    (\varepsilon_{\tmmathbf{k}} + 2 U_R n) - \gamma^2 n^2} \right) & 0\\
    0 & - \left( - 2 i \gamma + \sqrt{\varepsilon_{\tmmathbf{k}}
