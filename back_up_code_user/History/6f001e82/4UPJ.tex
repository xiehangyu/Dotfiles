...
\textcolor{red}{In this section, we investigate the quantum depletion density, the density of the non-condensed part, of a molecular BEC.} %\pk{Furthermore, we calculate the superfluid density in the quantum depletion part by considering a coordinate transformation $\bm{v}\to\bm{v}-\bm{v}'$ and the normal density by considering a coupling field to the action $\bm{k}\cdot{\bm{\j}}$.} To this end, 
...
\begin{equation}
a_{0}^{\dagger}a_{0}\approx N,\sum_{\bm{k}\neq0}a_{\bm{k}}^{\dagger}a_{\bm{k}}\ll N.
\end{equation}
...
\begin{equation}
\sum_{\bm{k},\bm{q},\bm{p}}a_{\bm{k}+}^{\dagger}a_{\bm{p}+}^{\dagger}a_{\bm{p}-\bm{q},+}a_{\bm{k}+\bm{q},+}\approx N^{2}+N\sum_{\bm{k}\neq0}a_{-\bm{k},+}a_{\bm{k}+}+N\sum_{\bm{k}\neq0}a_{\bm{k}+}^{\dagger}a_{-\bm{k},+}^{\dagger}+4N\sum_{\bm{k}\neq0}a_{\bm{k}+}^{\dagger}a_{\bm{k}+},\label{mean1}
\end{equation}
