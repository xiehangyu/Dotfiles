...
S & = & \int_{-\infty}^{\infty}dt\Bigg[\pk{\frac{V}{(2\pi^3)}\int d^3}\bm{k}(a_{\bm{k}+}^{\dagger}(i\partial_{t}-\varepsilon_{\bm{k}})a_{\bm{k}+}-a_{\bm{k}-}^{\dagger}(i\partial_{t}-\varepsilon_{\bm{k}})a_{\bm{k}-})-\frac{U_{R}}{2V}a_{0+}^{\dagger}a_{0+}^{\dagger}a_{0,+}a_{0,+}+\frac{U_{R}}{2V}a_{0-}^{\dagger}a_{0-}^{\dagger}a_{0,-}a_{0,-}\nonumber \\
 ...
 &  & +\frac{Un}{2}\pk{\frac{V}{(2\pi^3)}\int d^3}\bm{k}a_{\bm{k}-}^{\dagger}a_{-\bm{k},-}^{\dagger}+2U^{\ast}n\pk{\frac{V}{(2\pi^3)}\int d^3}\bm{k}a_{\bm{k}-}^{\dagger}a_{\bm{k}-}-4i\gamma n\sum_{\bm{k}}a_{\bm{k}-}^{\dagger}a_{\bm{k}+}\Bigg]\\
...
where 
\begin{eqnarray}
H_{\alpha} & = & \frac{U_{R}}{2V}a_{0\alpha}^{\dagger}a_{0\alpha}^{\dagger}a_{0\alpha}a_{0\alpha}+\sum_{\bm{k}}\left[(\varepsilon_{\bm{k}}-\mu+2U_{R}n-2i\alpha\gamma n)a_{\bm{k}\alpha}^{\dagger}a_{\bm{k}\alpha}+\frac{U^{\ast}n}{2}a_{-\bm{k}\alpha}a_{\bm{k}\alpha}+\frac{Un}{2}a_{\bm{k}\alpha}^{\dagger}a_{-\bm{k}\alpha}^{\dagger}\right]\nonumber \\
