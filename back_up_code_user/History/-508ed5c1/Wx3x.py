...
with open("missrate64k.csv", 'w', newline='') as file:
    writer = csv.writer(file)
    writer.writerows(datas)
with open("cpi64k.csv", 'w', newline='') as file:
    writer = csv.writer(file)
    writer.writerows(datas2)
with open("simTicks64k.csv", 'w', newline='') as file:
    writer = csv.writer(file)
