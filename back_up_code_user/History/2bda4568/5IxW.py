...
class dynamical_monte:
    ...
    def Page_curve_like(self,NAs):
        ...
        fp=open("./plot_data/calculate_by_python_Nsize{}norder{}initialtime{}timestep{}Samplingsize{}.txt".format(self.Nsize,self.norder,self.initial_time,self.time_steps,self.Samplingsize),'w')
...
if __name__=="__main__":
    Nsize=200
    instance=dynamical_monte(Nsize,3,200000,100000000,0.2)
    NAs=[i for i in range(1,Nsize//2,2)]
