...
def trial_eigenvalues(N,alpha=0.1,if_drawing=True):
    ...
    largesteigenvalues(rho,N,alpha,False)
    overlapstates_totalangularoperator(rho,N,alpha,False)
    cutoff=1E-7
    ranks=rank_of_states(results,cutoff,False)
