...
\begin{equation}
  ...
  \end{array}\right) .
\end{equation}
It shoule be also noted that the original action in the keldysh basis is Hermitian, therefore we can easily choose a Bogoliubov transformation which keeps $\bar{\beta}=\beta^\dagger$ by demanding that the matrix diagonalizing $G^\dagger$ and the one diagonalizing $G$ is related by Hermitian conjugating.
